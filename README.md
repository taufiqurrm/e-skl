...
| **QR Code di PDF** | Kode QR di PDF dapat dipindai untuk verifikasi keaslian SKL secara online |
...
| Fitur | Keterangan |
|-------|-----------|
| **Nama Sekolah** | Nama madrasah (tampil di kop surat PDF) |
| **NPSN** | Nomor Pokok Sekolah Nasional |
| **Kepala Sekolah** | Nama kepala madrasah (tampil di tanda tangan PDF) |
| **NIP** | NIP kepala madrasah |
| **Kota** | Kota untuk tanggal surat (contoh: Pamekasan) |
| **Website & Email** | Informasi kontak sekolah |
...
- Tanda tangan kepala madrasah + QR Code verifikasi
